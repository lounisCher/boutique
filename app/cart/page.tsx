      ...
      <div className="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8">
        <div className="mx-auto max-w-3xl">
          ...
          <div className="mt-8">
                    ...
                    item.product&&
                        ...
                        <div>
                          ...
                          <dl className="mt-0.5 space-y-px text-[10px] text-primary/75 text-md">
                            <div>
                              <p className="inline">Categories: {item.product.category}</p>                             
                            </div>
                        ...
                        <div>
                              <p className="inline font-bold text-primary/65">Prix: {item.product.price}DA</p>
                            </div>                      
              ...
              <div className="w-screen max-w-lg space-y-4">
                <div className="space-y-0.5 text-sm text-gray-700">
                  <div className="flex justify-between !text-base font-medium">
                    ...
                    <p className="font-bold text-primary text-xl">{getTotalAmount()}DA</p>
                  </div>
                </div>
            ...
            <h2 className=" font-bold text-xl text-primary/35 ">Note: Tous vos items seront via email</h2>
          </div>
        </div>
      </div>
    </section>
